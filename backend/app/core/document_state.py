...
class DocumentStateMachine:
    _allowed_transitions: ClassVar[set[tuple[str, str]]] = {
        ...
        # 环境级 AI 硬关闭后的遗留恢复。只允许 AI service 将已经进入中间态的
        # 旧任务显式收敛回草稿; 或按上传快照直接续接审核。
        ("extracting_text", "uploaded"),
        ("analysis_queued", "uploaded"),
        ("analyzing", "uploaded"),
        ("extracting_text", "pending_review"),
        ("analysis_queued", "pending_review"),

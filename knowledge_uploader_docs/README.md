...
1. `02_ARCHITECTURE_最终架构设计.md`
2. `03_BACKEND_SPEC_后端开发规范.md`
3. `04_FRONTEND_SPEC_前端开发规范.md`
4. `05_DATABASE_API_SPEC_数据库与API规范.md`
5. `10_CODEX_IMPLEMENTATION_PROMPT.md`
